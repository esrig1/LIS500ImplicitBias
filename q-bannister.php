...
$question_text = "Do you agree or disagree with the following statement: implicit bias training helps create more inclusive school and work environments.";
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $selectedAnswer = isset($_POST['answer']) ? $_POST['answer'] : null;
    $_SESSION['bannister_answer'] = $selectedAnswer;
    header("Location: q-blairmoon.php");
    exit();
}
...
<form method="post" action="q-bannister.php">
